...
public class Home extends JFrame implements ActionListener {
    ...
    JButton view, add, update, remove, addSchedule, viewSchedule, employeeAttendance, employeePerformance;
